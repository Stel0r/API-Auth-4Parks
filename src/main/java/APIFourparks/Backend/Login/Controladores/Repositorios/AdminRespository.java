...
public interface AdminRespository extends CrudRepository<Administrador,String>{
    ...
    @Query(value = "select select c.I_TIPO_DOC tipoDoc, c.K_NUM_DOCUMENTO numDocumento, CONCAT(u.N_PRIMER_NOMBRE, ' ' ,u.N_PRIMER_APELLIDO) as nombre,u.O_EMAIL as email, u.I_ESTADO as estado from CLIENTE c,USUARIO u where c.N_NOMBRE_USUARIO = u.N_NOMBRE_USUARIO;")
